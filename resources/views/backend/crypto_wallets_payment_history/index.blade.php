...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>    
            <div class="col-xs-12 col-md-4 p-0">Crypto Wallets Payment History</div>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="col-md-12 text-left m-b-md">
            {!! Form::open(['route' => 'crypto_wallets_payment_history.index','class'=>'form-inline','method'=>'get','id'=>'filter_request']) !!}
                <div class="col-sm-12 p-0">           
                    ...
                    <div class="form-group">                                
                        {!! Form::select('status',['1'=>'Approved','2'=>'Rejected','3'=>'Pending','4'=>'Added'],old('status',@$data['status']),['class'=>'form-control','placeholder'=>'All Status']) !!}
                    </div>         
                    <button class="btn btn-primary" type="submit"><i class="fa fa-filter"></i> Search</button>
                    <a class="btn btn-danger" href="{{route('crypto_wallets_payment_history.index')}}">Clear</a>
                </div>
            ...
            <div class="ibox ">
                ...
                <div class="ibox-content bg-dark-blue">
                    <div class="include-html">
                        @include('backend.crypto_wallets_payment_history.partials.table')
                    </div>
                </div>
            </div>
        </div>
...
var report_export = "{{route('crypto_wallets_payment_history.export')}}" 
</script>

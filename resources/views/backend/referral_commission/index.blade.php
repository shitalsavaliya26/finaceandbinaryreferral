...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>
            <div class="col-xs-12 col-md-4 p-0">[{{ $name->username ?? $name->name }}] Referral Commission</div>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="col-md-12 text-left m-b-md">
            {{-- {!! Form::open(['route' => 'referral_commission.index','class'=>'form-inline','method'=>'get','id'=>'filter_request']) !!}
                <div class="col-sm-12 p-0">           
                    ...
                    <a class="btn btn-danger" href="{{route('referral_commission.index')}}">Clear</a>
                </div>
            ...
            <div class="ibox ">
                ...
                <div class="ibox-content bg-dark-blue">
                    <div class="include-html">
                        @include('backend.referral_commission.partials.table')
                    </div>
                </div>
            </div>
        </div>

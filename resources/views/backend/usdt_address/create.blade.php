...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>    
            <div class="col-xs-12 col-md-3 p-0">Create New USDT Address</div>
        </h2>
    </div>
</div>
        ...
        <div class="col-lg-6">
            <div class="ibox float-e-margins">
                <div class="ibox-content ibox-border-rad cus-heght-full">
                    ...
                    {!! Form::open(['route' => 'usdt_address.store','autocomplete'=>'false','files'=>true,'id'=>'usdt_address','method'=>'post']) !!}

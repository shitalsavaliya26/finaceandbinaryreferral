...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>    
            <div class="col-xs-12">Create New NFT Product</div>
        </h2>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content ibox-border-rad cus-heght-full">
                    ...
                    {!! Form::open(['route' => 'nft-product.store','autocomplete'=>'false','files'=>true,'id'=>'nft_product_create','method'=>'post', 'files'=>true,]) !!}

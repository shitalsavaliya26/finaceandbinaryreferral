...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        ...
        <div class="col-xs-12 col-md-12 text-right">
            {!! Form::open(['route' => 'withdrawal_request.index','class'=>'form-inline','method'=>'get','id'=>'filter_request']) !!}
            <div class="row m-t-md">
                ...
                <a class="btn btn-danger  btn-sm" href="{{route('withdrawal_request.index')}}">Clear</a>
            </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="15%">
                                    {{-- @role('admin') --}}
                                    {!! Form::open(['route' => ['withdrawal_request.update',$row->id],'onsubmit'=>"return false;"]) !!}
                                    @if($row->status == '0')
...
<div class="hidden">
    {!! Form::open(['route' => ['withdrawal_request.update','bulk-update'],'id'=>"update_withdrawal_requests"]) !!}
    @method('patch')
...
<div id="open_remark_modal" class="modal fade open-remark-model" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            {!! Form::open(['route'=>['withdrawal_request.update',''],'method'=>'post','class'=>'form-vertical','id'=>'open_remark_model','autocomplete'=>'false','files'=>true]) !!}
            @method('patch')

...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>    
            <div class="col-xs-12 col-md-4 p-0">NFT Wallets Payment History</div>
            <div class="col-xs-12 col-md-8 text-right">
                {{-- @role('admin') --}}
                    <a class="btn  btn-info" onclick="exportnftPaymentHistoryFunction()">Export</a>
                {{-- @endrole --}}
            </div>
        </h2>
    </div>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="col-md-12 text-left m-b-md">
            {!! Form::open(['route' => 'nft_wallets_payment_history.index','class'=>'form-inline','method'=>'get','id'=>'filter_request']) !!}
                <div class="col-sm-12 p-0">           
                    ...
                    <a class="btn btn-danger" href="{{route('nft_wallets_payment_history.index')}}">Clear</a>
                </div>
            ...
            <div class="ibox ">
                ...
                <div class="ibox-content bg-dark-blue">
                    <div class="include-html">
                        @include('backend.nft_wallets_payment_history.partials.table')
                    </div>
                </div>
            </div>
        </div>
...
var report_export = "{{route('nft_wallets_payment_history.export')}}" 
</script>

...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2>    
            <div class="col-xs-12 col-md-3 p-0">Yield Wallet History</div>
            <div class="col-xs-12 col-md-9 text-right">
                {{-- @role('admin') --}}
                    <a class="btn  btn-info" onclick="exportPaymentHistoryFunction()">Export</a>
                {{-- @endrole --}}
            </div>
        </h2>
    </div>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="col-md-12 text-left m-b-md">
            {!! Form::open(['route' => 'yield_wallet.index','class'=>'form-inline','method'=>'get','id'=>'filter_request']) !!}
                <div class="col-sm-12 p-0">           
                    ...
                    {{-- <div class="form-group">                                
                        {!! Form::select('type',['0'=>'Wallet','1'=>'USDT','3'=>'Omini','6'=>'Direct Transfer'],old('status',@$data['type']),['class'=>'form-control','placeholder'=>'All']) !!}
                    </div>  --}}
                    {{-- <div class="form-group">                                
                        {!! Form::select('promo_account',['1'=>'Yes','2'=>'No'],old('promo_account',@$data['promo_account']),['class'=>'form-control','placeholder'=>'All']) !!}
                    </div>  --}}
                    <div class="form-group">                                
                        {!! Form::select('status',['1'=>'Added','2'=>'Reduce'],old('status',@$data['status']),['class'=>'form-control','placeholder'=>'All Status']) !!}
                    </div>         
                    <button class="btn btn-primary" type="submit"><i class="fa fa-filter"></i> Search</button>
                    <a class="btn btn-danger" href="{{route('yield_wallet.index')}}">Clear</a>
                </div>
            ...
            <div class="ibox ">
                ...
                <div class="ibox-content bg-dark-blue">
                    <div class="include-html">
                        @include('backend.yield_wallet.partials.table')
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
 var report_export = "{{route('yield-wallet-history-export.export')}}"
</script>
